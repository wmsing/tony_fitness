...
4. 画面上随机出现 **1～2 只**怪，角落随机（左上 / 右上 / 左下 / 右下）；击中会闪红、抖一下并飘字扣血；击杀后会再随机补怪
...
- **开始运动 / 暂停**：开始或暂停砸怪；开始时底部播放器播放 YouTube 列表（默认[这张列表](https://www.youtube.com/watch?v=MbD7TAlBFDc&list=PLGE-oAi0TRbtlX5kvtO415sergiyGEyUp)）。底部显示**歌名 / 歌手**，可用 **‹ ›** 切歌，中间按钮在**随机**与**单曲循环**间切换；右上角可更换播放列表。暂停游戏或关闭摄像头时音乐继续播（可用播放器手动停）
